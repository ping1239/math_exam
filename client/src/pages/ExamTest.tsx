    ...
    const loadExamData = async () => {
      try {
        ...
        if (examId === 'math-2024-01') {
          ...
          subtitle = mod.EXAM_SUBTITLE;
          score = mod.TOTAL_SCORE;
        } else if (examId === 'math-2024-11') {
          const mod = await import('@/lib/examData11');
          data = mod.questions;
          title = mod.EXAM_TITLE;
          subtitle = mod.EXAM_SUBTITLE;
          score = mod.TOTAL_SCORE;
        } else if (examId === 'math-2024-12') {
          const mod = await import('@/lib/examData12');
          data = mod.questions;
          title = mod.EXAM_TITLE;
          subtitle = mod.EXAM_SUBTITLE;
          score = mod.TOTAL_SCORE;
        } else if (examId === 'math-2024-13') {
          const mod = await import('@/lib/examData13');
          data = mod.questions;
          title = mod.EXAM_TITLE;
          subtitle = mod.EXAM_SUBTITLE;
          score = mod.TOTAL_SCORE;
