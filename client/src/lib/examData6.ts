...
처음 분수는 [frac:8/99]이므로 순환소수로는 0.[dot:0][dot:8] 입니다.`
  },
  {
    ...
    subQuestions: [
      { id: '12-1', text: 'a와 b를 각각 구하고 a-b의 값을 구하는 과정을 서술하시오.', score: 6 , answer: `61` }
    ],
    answer: `61`,
...
- 분수 [frac:a/b] 를 기약분수로 나타내면 분자가 1이고, 소수로 나타내면 1보다 작은 유한소수이다.`,
    subQuestions: [
      { id: '13-1', text: 'a와 b의 값을 구하는 과정을 서술하시오.', score: 6 , answer: `a=3,b=6` }
    ],
    answer: `a=3,b=6`,
...
−6xy(x−3)+(9x[sup:2]y[sup:2]−12xy[sup:2])÷[frac:3/2]y`,
  ...
  },
  {
    ...
    subQuestions: [
      { id: '26-1', text: '과정을 서술하시오.', score: 6 , answer: `a[sup:2]+16ab−10b[sup:2]` }
    ],
  ...
  },
  {
    ...
    subQuestions: [
      { id: '27-1', text: '과정을 서술하시오.', score: 6 , answer: `4a` }
    ],
    answer: `4a`,
...
입니다. 이를 풀면 나옵니다.`
  },
  {
    ...
    subQuestions: [
      { id: '40-1', text: '과정을 서술하시오.', score: 6 , answer: `4편 이상` }
    ],
    answer: `4편 이상`,
  ...
  },
  {
    ...
    subQuestions: [
      { id: '41-1', text: '과정을 서술하시오.', score: 6 , answer: `숙박비 지원 120명, 체험비 지원 80명` }
    ],
...
- 직선 3x−by+4=0 과 만나지 않는다.`,
  ...
  },
  {
    ...
    subQuestions: [
      { id: '54-1', text: '과정을 서술하시오.', score: 6 , answer: `제1사분면` }
    ],
    answer: `제1사분면`,
...
(2) 화씨온도가 95∘F일 때, 섭씨온도는 몇 ∘C인지 구하시오.`,
    subQuestions: [
      { id: '55-1', text: '과정을 서술하시오.', score: 6 , answer: `(1) y=[frac:9/5]x+32 (2) 35∘C` }
    ],
