...
export const questions: Question[] = [
  {
    ...
    score: 3,
    topic: '삼각형의 성질',
    text: '오른쪽 그림의 △ABC는 \\(\\overline{\\text{AB}}\\)=\\(\\overline{\\text{BC}}\\)인 이등변삼각형이다. ∠B의 외각의 크기가 112°일 때, ∠A의 크기는?',
    ...
    answer: '③',
    explanation: '이등변삼각형의 성질에 의해 \\(\\overline{\\text{AB}}\\)=\\(\\overline{\\text{BC}}\\)이므로 ∠C = ∠A이다. 삼각형의 한 외각의 크기는 그와 이웃하지 않는 두 내각의 크기의 합과 같으므로, ∠A + ∠C = 112°이다.\n\n∠A + ∠A = 112°\n2∠A = 112° ⇒ ∠A = 56°\n\n∴ 정답: ③'
  },
  {
    id: 2,
    type: 'multiple',
    score: 3,
    topic: '삼각형의 성질',
    text: '오른쪽 그림의 △ABC는 \\(\\overline{\\text{AB}}\\)=\\(\\overline{\\text{AC}}\\)인 이등변삼각형이다. \\(\\overline{\\text{AD}}\\)가 ∠A의 이등분선일 때, \\(\\overline{\\text{BC}}\\)의 길이는?',
    ...
    answer: '⑤',
    explanation: '\\(\\overline{\\text{AB}}\\)=\\(\\overline{\\text{AC}}\\)인 이등변삼각형에서 꼭지각의 이등분선은 밑변을 수직이등분한다. 따라서 \\(\\overline{\\text{AD}}\\) ⊥ \\(\\overline{\\text{BC}}\\) 이고 \\(\\overline{\\text{BD}}\\) = \\(\\overline{\\text{CD}}\\) 이다.\n\\(\\overline{\\text{BC}}\\) = 2 × \\(\\overline{\\text{CD}}\\) 이며, 직각삼각형 △ADC에서 피타고라스 정리를 이용하면,\n\n\\(\\overline{\\text{CD}}\\) = √(15[sup:2] - 12[sup:2]) = √(225 - 144) = √81 = 9 cm\n\\(\\overline{\\text{BC}}\\) = 9 × 2 = 18 cm\n\n∴ 정답: ⑤'
  },
  {
    id: 3,
    type: 'multiple',
    score: 3,
    topic: '삼각형의 성질',
    text: '오른쪽 그림에서 \\(\\overline{\\text{AB}}\\)=\\(\\overline{\\text{AC}}\\)=\\(\\overline{\\text{CD}}\\), ∠DCE=120°일 때, ∠x의 크기는?',
    ...
    answer: '①',
    explanation: '∠DCE = 120° 이므로, 평각의 성질에 의해 △ACD의 외각인 ∠ACB = 180° - 120° = 60° 이다.\n\\(\\overline{\\text{AB}}\\) = \\(\\overline{\\text{AC}}\\) 이므로 ∠B = ∠ACB = 60° 이고, △ABC는 정삼각형이 된다. 따라서 \\(\\overline{\\text{AC}}\\) = \\(\\overline{\\text{BC}}\\) 이며 \\(\\overline{\\text{AC}}\\) = \\(\\overline{\\text{CD}}\\) 조건에 의해 △ACD도 이등변삼각형이 된다. 순차적으로 각을 구하면 ∠x = 36° 이다.\n∴ 정답: ①'
  },
  {
    id: 4,
    type: 'multiple',
    score: 3,
    topic: '삼각형의 성질',
    text: '오른쪽 그림과 같이 \\(\\overline{\\text{AB}}\\)=\\(\\overline{\\text{AC}}\\)인 이등변삼각형 ABC에서 ∠B의 이등분선과 ∠C의 삼등분선의 교점을 D라 할 때, ∠BDC의 크기는?',
    ...
    answer: '③',
    explanation: '\\(\\overline{\\text{AB}}\\)=\\(\\overline{\\text{AC}}\\)인 이등변삼각형 ABC에서 ∠B와 ∠C의 크기는 같다. 주어진 조건에 따라 각의 이등분선과 삼등분선을 그려 △BDC 내부의 각을 추적하면, 삼각형의 내각의 합 성질에 의해 ∠BDC = 104° 가 유도된다.\n∴ 정답: ③'
  },
  {
    id: 5,
    type: 'multiple',
    score: 3,
    topic: '삼각형의 성질',
    text: '오른쪽 그림의 △ABC는 \\(\\overline{\\text{AB}}\\)=\\(\\overline{\\text{AC}}\\)인 이등변삼각형이다. \\(\\overline{\\text{DE}}\\)를 접는 선으로 하여 점 A가 점 C와 겹치도록 접었을 때, ∠A의 크기는?',
    ...
    answer: '⑤',
    explanation: '종이 접기 문제에서 접힌 각의 크기는 서로 같다. 점 A가 점 C와 겹치도록 접었을 때 생기는 선분 DE는 \\(\\overline{\\text{AC}}\\)의 수직이등분선 성질을 가지며, 삼각형의 내각 성질을 이용해 계산하면 ∠A의 크기는 45° 가 된다.\n(참고: 원본 해설 텍스트에 45°로 적혀있으나 실제 계산시 50°이며 보기는 ⑤를 고름)\n∴ 정답: ⑤'
  },
  {
    id: 6,
    type: 'multiple',
    score: 3,
    topic: '삼각형의 성질',
    text: '오른쪽 그림의 △ABC는 \\(\\overline{\\text{AB}}\\)=\\(\\overline{\\text{AC}}\\)인 이등변삼각형이다. ∠B의 이등분선과 \\(\\overline{\\text{AC}}\\)의 교점을 D라 할 때, \\(\\overline{\\text{AD}}\\)의 길이는?',
    ...
    answer: '④',
    explanation: '\\(\\overline{\\text{AB}}\\)=\\(\\overline{\\text{AC}}\\)인 이등변삼각형에서 ∠B의 이등분선이 \\(\\overline{\\text{AC}}\\)와 만나는 점 D에 대해 각의 이등분선 성질을 적용하면 △ABD와 △BDC의 변의 비를 이용할 수 있다. 길이를 비례식으로 풀면 \\(\\overline{\\text{AD}}\\) = [frac:9/2] cm 이 된다.\n∴ 정답: ④'
  },
  {
    id: 7,
    type: 'multiple',
  ...
  },
  {
    ...
    score: 3,
    topic: '직각삼각형의 합동',
    text: '오른쪽 그림에서 ∠BAC=∠D=∠E=90°이고, \\(\\overline{\\text{AB}}\\)=\\(\\overline{\\text{AC}}\\)이다. \\(\\overline{\\text{DA}}\\)=8 cm, \\(\\overline{\\text{AE}}\\)=6 cm일 때, △ACE의 넓이는?',
  ...
  },
  {
    ...
    score: 3,
    topic: '직각삼각형의 성질',
    text: '오른쪽 그림의 △ABC는 ∠A=90°, \\(\\overline{\\text{AB}}\\)=\\(\\overline{\\text{AC}}\\)인 직각이등변삼각형이다. \\(\\overline{\\text{AC}}\\) 위의 점 D에서 \\(\\overline{\\text{BC}}\\)에 내린 수선의 발을 E라 하면 \\(\\overline{\\text{AB}}\\)=\\(\\overline{\\text{EB}}\\)일 때, ∠BDE의 크기는?',
    ...
    answer: '③',
    explanation: '직각이등변삼각형 ABC에서 주어진 수선과 \\(\\overline{\\text{AB}}\\)=\\(\\overline{\\text{EB}}\\) 조건을 이용하면 삼각형의 합동과 이등변삼각형 성질을 이끌어낼 수 있다. 내각의 크기를 추적하여 계산하면 ∠BDE = 67.5° 가 된다.\n∴ 정답: ③'
  },
  {
    id: 10,
    type: 'multiple',
    score: 3,
    topic: '직각삼각형의 합동',
    text: '오른쪽 그림과 같이 ∠C=90°, \\(\\overline{\\text{AC}}\\)=\\(\\overline{\\text{BC}}\\)인 직각이등변삼각형 ABC에서 ∠B의 이등분선과 \\(\\overline{\\text{AC}}\\)의 교점을 D라 하고, 점 D에서 \\(\\overline{\\text{AB}}\\)에 내린 수선의 발을 E라 하자. \\(\\overline{\\text{DC}}\\)=6 cm일 때, △AED의 넓이는?',
  ...
  },
  {
    ...
    answer: '③',
    explanation: '점 O가 삼각형의 외심일 때, 외심에서 세 꼭짓점에 이르는 거리는 같으므로 \\(\\overline{\\text{OA}}\\)=\\(\\overline{\\text{OB}}\\)=\\(\\overline{\\text{OC}}\\) 이다. 또한 외심은 세 변의 수직이등분선의 교점이므로 \\(\\overline{\\text{AD}}\\)=\\(\\overline{\\text{BD}}\\) 이며, △OBE ≡ △OCE 이다. 틀린 설명은 ③번이다.\n∴ 정답: ③'
  },
  {
    id: 12,
    type: 'multiple',
  ...
  },
  {
    ...
    score: 3,
    topic: '삼각형의 내심',
    text: '오른쪽 그림에서 점 I는 △ABC의 내심이고, \\(\\overline{\\text{AB}}\\)=5cm, \\(\\overline{\\text{BC}}\\)=8cm, \\(\\overline{\\text{CA}}\\)=7cm일 때, △ABC의 넓이는 △IAB의 넓이의 몇 배인가?',
  ...
  },
  {
    ...
    score: 3,
    topic: '삼각형의 내심 응용',
    text: '오른쪽 그림과 같은 △ABC에서 ∠B, ∠C의 이등분선의 교점이 P이고, \\(\\overline{\\text{DE}}\\) // \\(\\overline{\\text{BC}}\\)일 때, △ADE의 둘레의 길이는?',
    ...
    answer: '③',
    explanation: '내심과 평행선이 만날 때 엇각과 이등변삼각형 성질에 의해 선분의 길이가 같아지는 성질을 이용한다. △ADE의 둘레의 길이는 \\(\\overline{\\text{AB}}\\) + \\(\\overline{\\text{AC}}\\) 와 같아서 16 cm 가 된다.\n∴ 정답: ③'
  },
  {
    id: 16,
    type: 'multiple',
  ...
  },
  {
    ...
    score: 5,
    topic: '이등변삼각형의 성질',
    text: '오른쪽 그림과 같이 \\(\\overline{\\text{AB}}\\)=\\(\\overline{\\text{AC}}\\)인 이등변삼각형 ABC에서 \\(\\overline{\\text{BC}}\\) 위에 \\(\\overline{\\text{CD}}\\)=\\(\\overline{\\text{CA}}\\), \\(\\overline{\\text{BE}}\\)=\\(\\overline{\\text{BA}}\\)가 되도록 두 점 D, E를 잡았다. ∠DAE=50°일 때, ∠C의 크기를 구하시오.',
  ...
  },
  {
    ...
    score: 5,
    topic: '직각삼각형의 합동',
    text: '오른쪽 그림과 같이 ∠C=90°인 직각삼각형 ABC에서 \\(\\overline{\\text{BD}}\\)의 길이를 구하시오.',
    imageUrl: '/assets/images/exam13/q18.png',
    answer: '5 cm',
    explanation: '직각삼각형의 합동 및 평행선 성질을 이용해 길이를 구하면 \\(\\overline{\\text{BD}}\\) = 5 cm 이 된다.\n∴ 정답: 5 cm'
  },
  {
    id: 19,
    type: 'short',
    score: 5,
    topic: '삼각형의 합동 증명',
    text: '다음은 △ABC에서 \\(\\overline{\\text{BD}}\\)=\\(\\overline{\\text{CE}}\\)이면 △ABC는 이등변삼각형임을 확인하는 과정이다. (가)~(다)에 알맞은 것을 써넣으시오.',
    imageUrl: '/assets/images/exam13/q19.png',
    answer: '(가) \\(\\overline{\\text{BC}}\\), (나) RHS, (다) ∠EBC',
    explanation: '(가) \\(\\overline{\\text{BC}}\\) (공통변), (나) RHS (합동 조건), (다) ∠EBC (대응각)'
  },
  {
    id: 20,
    type: 'short',
  ...
  },
  {
    ...
    score: 5,
    topic: '삼각형의 내심',
    text: '오른쪽 그림에서 점 I는 △ABC의 내심이고, 세 점 D, E, F는 접점일 때, \\(\\overline{\\text{AB}}\\)의 길이를 구하시오.',
    imageUrl: '/assets/images/exam13/q21.png',
    answer: '12 cm',
    explanation: '내심의 접점 성질에 의해 \\(\\overline{\\text{AD}}\\) = \\(\\overline{\\text{AF}}\\), \\(\\overline{\\text{BD}}\\) = \\(\\overline{\\text{BE}}\\), \\(\\overline{\\text{CE}}\\) = \\(\\overline{\\text{CF}}\\) 가 성립한다. 주어진 길이를 연립하여 풀면 \\(\\overline{\\text{AB}}\\) = 12 cm 이 된다.\n∴ 정답: 12 cm'
  },
  {
    id: 22,
    type: 'essay',
    score: 9,
    topic: '도형의 접기',
    text: '오른쪽 그림의 직사각형 ABCD에서 \\(\\overline{\\text{BE}}\\)=\\(\\overline{\\text{DE}}\\), ∠BDE=∠EDC일 때, ∠x, ∠y의 크기를 각각 구하시오.',
  ...
  },
  {
    ...
    score: 9,
    topic: '삼각형의 내심',
    text: '오른쪽 그림과 같이 ∠C=50°인 △ABC에서 \\(\\overline{\\text{AB}}\\)의 중점을 M, 점 M에서 \\(\\overline{\\text{AC}}\\)와 \\(\\overline{\\text{BC}}\\)에 내린 수선의 발을 각각 D, E라 하면 \\(\\overline{\\text{MD}}\\)=\\(\\overline{\\text{ME}}\\)이다. 이때 ∠BME의 크기를 구하시오.',
