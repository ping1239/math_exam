...
export const questions: Question[] = [
  ...
  },
  {
    ...
    subQuestions: [
      { id: '17-1', label: '(1)', text: '두 부피의 차 V[sub:1]−V[sub:2]를 x, y에 대한 식으로 나타내시오.', score: 8 , answer: `[frac:8x[sup:5]y[sup:4]−4x[sup:4]y[sup:5]/π]` }
    ],
  ...
  },
  {
    ...
    subQuestions: [
      { id: '18-1', label: '(1)', text: 'a+b의 최댓값을 구하는 풀이 과정을 서술하시오.', score: 8 , answer: `15` }
    ],
    answer: `15`,
  ...
  },
  {
    ...
    subQuestions: [
      { id: '19-1', label: '(1)', text: '부등식을 세워 풀이 과정을 적고 답을 구하시오.', score: 8 , answer: `201장 이상` }
    ],
    answer: `201장 이상`,
