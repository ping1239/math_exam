...
export const questions: Question[] = [
  ...
  },
  {
    ...
    answer: '④',
    explanation: '□ABCD ∽ □EFGH에서 \\(\\overline{\\text{AD}}\\)의 대응변은 \\(\\overline{\\text{EH}}\\)야.\n닮음비는 \\(\\overline{\\text{AD}}\\) : \\(\\overline{\\text{EH}}\\) = 6 : 12 = 1 : 2 가 된단다.\n\\(\\overline{\\text{AB}}\\)의 대응변이 \\(\\overline{\\text{EF}}\\)이므로 비례식을 세우면 다음과 같아.\n\n1 : 2 = 3 : \\(\\overline{\\text{EF}}\\)\n\n∴ \\(\\overline{\\text{EF}}\\) = 6 cm\n\n∴ 정답: ④'
  },
  {
    id: 4,
    type: 'multiple',
  ...
  },
  {
    ...
    answer: '⑤',
    explanation: '두 사면체의 대응하는 모서리 \\(\\overline{\\text{BC}}\\)와 \\(\\overline{\\text{B}}\\)\'C\'의 비를 통해 두 입체도형의 닮음비가 1:2임을 알 수 있어.\n닮은 두 입체도형에서 대응하는 모든 모서리의 길이의 비는 일정하게 1:2가 되어야 한단다. ⑤번 보기는 이 비율을 잘못 나타내고 있어.\n∴ 정답: ⑤'
  },
  {
    id: 6,
    type: 'multiple',
  ...
  },
  {
    ...
    answer: '④',
    explanation: '△ABC와 △ADE를 살펴볼까? ∠A는 두 삼각형의 공통각이란다.\n대응하는 변의 길이의 비를 구해보면 \\(\\overline{\\text{AB}}\\):\\(\\overline{\\text{AD}}\\) = 21:14 = 3:2 이고, \\(\\overline{\\text{AC}}\\):\\(\\overline{\\text{AE}}\\) = 15:10 = 3:2 가 된단다.\n두 쌍의 대응변의 비가 같고 그 끼인각이 같으므로 △ABC ∽ △ADE (SAS 닮음)이야.\n따라서 밑변의 비도 같아야 하므로 \\(\\overline{\\text{BC}}\\):\\(\\overline{\\text{DE}}\\) = 3:2 가 성립해.\n\n9 : \\(\\overline{\\text{DE}}\\) = 3 : 2\n3\\(\\overline{\\text{DE}}\\) = 18 ⇒ \\(\\overline{\\text{DE}}\\) = 6 cm\n\n∴ 정답: ④'
  },
  {
    id: 12,
    type: 'multiple',
    ...
    answer: '③',
    explanation: '\\(\\overline{\\text{AD}}\\) // \\(\\overline{\\text{BC}}\\) 이므로 엇각인 ∠FAE = ∠FCB 이고, 맞꼭지각인 ∠AFE = ∠CFB 란다.\n따라서 두 각의 크기가 같으므로 △AFE ∽ △CFB (AA 닮음)이 돼.\n평행사변형은 마주 보는 대변의 길이가 같으므로 \\(\\overline{\\text{AD}}\\) = \\(\\overline{\\text{BC}}\\) 이고, 주어진 조건 \\(\\overline{\\text{AE}}\\):\\(\\overline{\\text{ED}}\\) = 2:1 에 의해 닮음비는 \\(\\overline{\\text{AE}}\\):\\(\\overline{\\text{BC}}\\) = 2:3 이야.\n대응변의 비례식 \\(\\overline{\\text{AF}}\\):\\(\\overline{\\text{FC}}\\) = 2:3 을 세울 수 있고, 전체 \\(\\overline{\\text{AC}}\\) = 15 cm 이므로 비례배분을 하면 된단다.\n\n\\(\\overline{\\text{AF}}\\) = 15 × [frac:2/2+3] = 15 × [frac:2/5] = 6 cm\n\n∴ 정답: ③'
  },
  {
    id: 13,
    type: 'multiple',
  ...
  },
  {
    ...
    answer: '③',
    explanation: '△ABC와 △EDC에서 ∠C는 공통각이고, ∠A = ∠DEC = 90° 이므로 AA 닮음이 성립해.\n두 닮은 삼각형의 대응변 길이 비례식인 \\(\\overline{\\text{AC}}\\):\\(\\overline{\\text{EC}}\\) = \\(\\overline{\\text{BC}}\\):\\(\\overline{\\text{DC}}\\) 를 세울 수 있단다.\n문제 그림에 주어진 선분들의 길이를 대입하여 \\(\\overline{\\text{DC}}\\)의 길이를 우선적으로 구해야 해.\n비례식을 풀어 \\(\\overline{\\text{DC}}\\)를 구한 뒤, \\(\\overline{\\text{AD}}\\) = \\(\\overline{\\text{AC}}\\) - \\(\\overline{\\text{DC}}\\) 의 식에 대입하여 계산하면 최종적으로 \\(\\overline{\\text{AD}}\\) = 4 cm 가 도출된단다.\n∴ 정답: ③'
  },
  {
    id: 15,
    type: 'multiple',
  ...
  },
  {
    ...
    answer: '20/3 cm',
    explanation: '평행선이 주어졌을 때는 \'동위각과 엇각의 크기가 같다\'는 사실을 최우선으로 생각해야 해.\n문제 조건인 \\(\\overline{\\text{AB}}\\) // \\(\\overline{\\text{DE}}\\) 와 \\(\\overline{\\text{AD}}\\) // \\(\\overline{\\text{BC}}\\) 의 평행선 성질을 이용하면, 내부에서 각의 크기가 같은 닮은 두 삼각형(AA 닮음)을 짝지어 찾아낼 수 있어.\n그 찾아낸 닮은 삼각형에서 \'대응변의 길이의 비는 일정하다\'는 것을 이용해 비례식을 세워 풀면 \\(\\overline{\\text{CE}}\\) = [frac:20/3] cm 가 도출된단다.\n∴ 정답: [frac:20/3] cm'
  },
  {
    id: 20,
    type: 'short',
  ...
  },
  {
    ...
    answer: '39 cm²',
    explanation: '직각삼각형에서 직각인 꼭짓점으로부터 빗변에 수선을 내렸을 때 성립하는 공식 중 하나인 \\(\\overline{\\text{AD}}\\)[sup:2] = \\(\\overline{\\text{BD}}\\) × \\(\\overline{\\text{CD}}\\)를 이용하는 문제란다.\n그림에서 주어진 \\(\\overline{\\text{BD}}\\) = 4, \\(\\overline{\\text{CD}}\\) = 9를 공식에 대입해 보자.\n\n\\(\\overline{\\text{AD}}\\)[sup:2] = 4 × 9 = 36\n\n따라서 높이 \\(\\overline{\\text{AD}}\\)는 6 cm가 된단다.\n밑변 \\(\\overline{\\text{BC}}\\)의 길이는 \\(\\overline{\\text{BD}}\\) + \\(\\overline{\\text{CD}}\\) = 4 + 9 = 13 cm이므로, △ABC의 넓이는 삼각형 넓이 공식에 따라 다음과 같이 구할 수 있어.\n\n△ABC 넓이 = [frac:1/2] × 13 × 6 = 39\n\n∴ 정답: 39 cm²'
  },
  {
    id: 22,
    type: 'essay',
    ...
    subQuestions: [
      ...
      { id: '22-2', label: '(2)', text: '\\(\\overline{\\text{C}}\\)\'D\'의 길이', score: 4, answer: '9cm', explanation: '그림에 주어진 대응변의 길이를 서로 비교하여 먼저 두 도형의 기준이 되는 닮음비를 구한단다.' }
    ],
    answer: '(1) 5:3\n(2) 9cm',
  ...
  },
  {
    ...
    subQuestions: [
      { id: '24-1', label: '(1)', text: '\\(\\overline{\\text{AM}}\\)의 길이', score: 3, answer: '25/2 cm', explanation: '(1) 점 M은 직각삼각형의 빗변 \\(\\overline{\\text{BC}}\\)의 중점이므로 이 직각삼각형의 외심에 해당해. 직각삼각형의 외심은 세 꼭짓점에 이르는 거리가 모두 같다는 성질이 있어. 따라서 \\(\\overline{\\text{AM}}\\) = [frac:1/2]\\(\\overline{\\text{BC}}\\) 수식을 통해 길이를 구한단다.' },
      { id: '24-2', label: '(2)', text: '\\(\\overline{\\text{AD}}\\)의 길이', score: 3, answer: '10 cm', explanation: '(2) 삼각형 넓이를 구하는 두 가지 관점을 응용한 공식인 \\(\\overline{\\text{AB}}\\) × \\(\\overline{\\text{AC}}\\) = \\(\\overline{\\text{BC}}\\) × \\(\\overline{\\text{AD}}\\) 에 주어진 선분 길이들을 대입하여 높이 \\(\\overline{\\text{AD}}\\)를 유도해 낼 수 있어.' },
      { id: '24-3', label: '(3)', text: '\\(\\overline{\\text{AE}}\\)의 길이', score: 3, answer: '8 cm', explanation: '(3) 수선이 내려지며 생긴 직각삼각형 내부의 닮음(AA 닮음) 비례식이나, 수선 공식을 한 번 더 적용하여 최종적으로 \\(\\overline{\\text{AE}}\\)의 길이를 계산하면 된단다.' }
    ],
    answer: '(1) 25/2 cm\n(2) 10 cm\n(3) 8 cm',
    explanation: '직각삼각형의 외심 성질과 소공식을 종합적으로 묻는 서술형 문제란다.\n(1) 점 M은 직각삼각형의 빗변 \\(\\overline{\\text{BC}}\\)의 중점이므로 이 직각삼각형의 외심에 해당해. 직각삼각형의 외심은 세 꼭짓점에 이르는 거리가 모두 같다는 성질이 있어. 따라서 \\(\\overline{\\text{AM}}\\) = [frac:1/2]\\(\\overline{\\text{BC}}\\) 수식을 통해 길이를 구한단다.\n(2) 삼각형 넓이를 구하는 두 가지 관점을 응용한 공식인 \\(\\overline{\\text{AB}}\\) × \\(\\overline{\\text{AC}}\\) = \\(\\overline{\\text{BC}}\\) × \\(\\overline{\\text{AD}}\\) 에 주어진 선분 길이들을 대입하여 높이 \\(\\overline{\\text{AD}}\\)를 유도해 낼 수 있어.\n(3) 수선이 내려지며 생긴 직각삼각형 내부의 닮음(AA 닮음) 비례식이나, 수선 공식을 한 번 더 적용하여 최종적으로 \\(\\overline{\\text{AE}}\\)의 길이를 계산하면 된단다.'
  }
];
